...
class Psoc4Prog(ChipProg):
    ...
    def create_instance(self,dev_path,what_chip):
        ...
        arch_type = dfu_common.get_chip_arch_type_support(self.rpc_client_node)["psoc4"]
        ...
        logger.info(dfu_common.get_chip_type_support(self.rpc_client_node,arch_type))
